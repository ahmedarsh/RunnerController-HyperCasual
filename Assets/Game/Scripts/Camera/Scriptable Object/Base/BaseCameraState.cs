...
{
    [FoldoutGroup("Field Of View Settings"), SerializeField, LabelText("Default FOV")]
    float deafultFOV = 60;

    [FoldoutGroup("Field Of View Settings"), SerializeField]
    bool changeFOV;

    [FoldoutGroup("Field Of View Settings"), ShowIf("changeFOV"), SerializeField, LabelText("Target FOV")]
    float targetFOV = 90;

    [FoldoutGroup("Field Of View Settings"), ShowIf("changeFOV"), SerializeField, Range(0.01f, 5),
     LabelText("FOV Change Speed")]
    float fOVChangeSpeed = 0.25f;

    [FoldoutGroup("Field Of View Settings"), SerializeField, Range(0.01f, 5), LabelText("Default FOV Change Speed")]
