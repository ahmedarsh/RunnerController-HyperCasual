...
public abstract class TKAbstractGestureRecognizer : IComparable<TKAbstractGestureRecognizer>
{
	...
	/// </summary>
	protected List<MTouch> _trackingTouches = new List<MTouch>();
	...
	/// </summary>
	private List<MTouch> _subsetOfTouchesBeingTrackedApplicableToCurrentRecognizer = new List<MTouch>();
	...
	/// </summary>
	protected bool isTrackingTouch( MTouch t )
	{
	...
	/// </summary>
	protected bool isTrackingAnyTouch( List<MTouch> touches )
	{
	...
	/// </summary>
	private bool populateSubsetOfTouchesBeingTracked( List<MTouch> touches )
	{
	...
	internal void recognizeTouches( List<MTouch> touches )
	{
	...
	internal bool isTouchWithinBoundaryFrame( MTouch touch )
	{
	...
	/// </summary>
	internal virtual bool touchesBegan( List<MTouch> touches )
	{
		return false;
	}


	internal virtual void touchesMoved( List<MTouch> touches )
	{}


	internal virtual void touchesEnded( List<MTouch> touches )
	{}
